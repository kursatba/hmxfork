...
class Public(object):
    ...
    def __multicall_market_data(self, market_index: int):
        ...
        (funding_interval, min_profit_duration, dev_fee_rate_bps, max_position) = (
    ...
    def get_open_orders(self, account: str, sub_account_id: int):
        ...
        orders = self.limit_trade_handler_instance.functions.getAllActiveOrdersBySubAccount(subacc,5,0).call()
        ret = []
        for order in orders:
            (
                account,
    ...
    def get_market_info(self, market_index: int):
        ...
        """
        print(f"Getting market index {market_index}")

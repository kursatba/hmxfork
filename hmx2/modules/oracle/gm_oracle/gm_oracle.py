...
from hmx2.constants import GM_PRICE_ADAPTER_ABI_PATH
import math
...
class GmOracle(object):
    ...
    def get_price(self, asset_id: str) -> float:
        ...
        prices.append(math.floor(self.pyth_oracle.get_price(self.asset_ids[0]) * 1e8))
        prices.append(math.floor(self.pyth_oracle.get_price(self.asset_ids[1]) * 1e8))
        prices.append(math.floor(self.pyth_oracle.get_price(self.asset_ids[2]) * 1e8))
